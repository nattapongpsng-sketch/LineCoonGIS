...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link type="ArcSDE Connection" name="SDE Feature Class" format="" mimeType="" size="" url="Server=peasvr; Service=pea_sde; User=495266; Version=SDE.DEFAULT" description=""/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial crs="EPSG:4326" dimensions="2" minz="0" maxy="1114541.34454900003038347" minx="414742.03210800001397729" maxz="0" miny="783583.90854900004342198" maxx="647054.51110799994785339"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
