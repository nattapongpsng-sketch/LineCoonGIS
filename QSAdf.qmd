...
<qgis version="3.40.5-Bratislava">
  <identifier>PEA.DS_Switch</identifier>
  <parentidentifier></parentidentifier>
  <language>TH</language>
  <type>dataset</type>
  <title>PEA.DS_Switch</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" name="SDE Feature Class" mimeType="" type="ArcSDE Connection" format="" size="" url="Server=peasvr; Service=pea_sde; User=495266; Version=SDE.DEFAULT"/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial minz="0" maxz="0" crs="EPSG:4326" miny="783583.90854900004342198" maxy="1114541.34454900003038347" dimensions="2" minx="414742.03210800001397729" maxx="647054.51110799994785339"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
