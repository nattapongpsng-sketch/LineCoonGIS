...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link type="ArcSDE Connection" name="SDE Feature Class" format="" mimeType="" size="" url="Server=172.27.252.200; Service=5159; User=472215; Version=SDE.DEFAULT" description=""/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial crs="EPSG:4326" dimensions="2" minz="0" maxy="1114116.60854899999685585" minx="422588.46710800001164898" maxz="0" miny="786134.40554900001734495" maxx="647072.8061079999897629"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
