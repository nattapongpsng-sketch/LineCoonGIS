...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" name="SDE Feature Class" mimeType="" type="ArcSDE Connection" format="" size="" url="Server=peasvr; Service=pea_sde; User=pea; Version=SDE.DEFAULT"/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial minz="0" maxz="0" crs="EPSG:32647" miny="782920.84149999998044223" maxy="1103277652.06049990653991699" dimensions="2" minx="376805.93609999999171123" maxx="35169170.24710000306367874"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
